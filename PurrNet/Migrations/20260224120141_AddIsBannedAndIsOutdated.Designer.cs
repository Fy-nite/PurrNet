...
namespace purrnet.Migrations
{
    ...
    [Migration("20260224120141_AddIsBannedAndIsOutdated")]
    partial class AddIsBannedAndIsOutdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PackageCategory", b =>
                {
            ...
            modelBuilder.Entity("Purrnet.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Purrnet.Models.PackageReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PackageCategory", b =>
                {
                    b.HasOne("Purrnet.Models.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Purrnet.Models.PackageReview", b =>
                {
                    b.HasOne("Purrnet.Models.Package", "Package")
                        .WithMany("Reviews")
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
